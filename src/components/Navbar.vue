    ...
    <div>
        <div class="navbar bg-base-100 shadow-sm">
            <div class="navbar-start">
                ...
                <RouterLink to="/" class="btn btn-ghost rounded-full text-xl font-bold"
                    ><LibraryBig />School Management</RouterLink
                >
            </div>
